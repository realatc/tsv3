...
const scamsMd = `# Common Digital Scams
...
const markdownStyles = {
  body: { color: '#B0BEC5', fontSize: 16 },
  heading1: { color: '#4A90E2', fontSize: 24, fontWeight: 'bold', marginBottom: 12 },
  heading2: { color: '#4A90E2', fontSize: 20, fontWeight: 'bold', marginTop: 18, marginBottom: 8 },
  list_item: { color: '#B0BEC5', fontSize: 16 },
};
